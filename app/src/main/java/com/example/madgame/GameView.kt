...
class GameView (var c :Context, var gameTask: GameTask):View(c)
{
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        val d = resources.getDrawable(R.drawable.cars_red,null)
        ...
        for (i in otherCars.indices){
            try {
                val carX = otherCars[i]["lane"] as Int * viewWidth / 15
                var carY = time - otherCars[i]["startTime"] as Int
                val d2 = resources.getDrawable(R.drawable.cars_white,null)
